  ...
  <div class="space-y-8">
    ...
    <div class="grid md:grid-cols-3 gap-8">
      <div class="card text-center">
        ...
        <p class="text-gray-600">Real-time collaboration with your team members during retrospectives.</p>
      </div>
      ...
      <div class="card text-center">
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">Action Tracking</h3>
        <p class="text-gray-600">Track action items and follow up on improvements from previous retrospectives.</p>
      </div>
      ...
      <div class="card text-center">
        ...
        <h3 class="text-lg font-semibold text-gray-900 mb-2">Progress Insights</h3>
        <p class="text-gray-600">Visualize your team's progress and identify patterns over time.</p>
      </div>
    </div>
  </div>
</template>
